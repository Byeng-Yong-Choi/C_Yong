...
{	
	...
	Char->Load(L"bitmap1.bmp", L"bitmap1mask.bmp");			//비트맵 이미지 로드
	Monster->Load(L"bitmap1.bmp", L"bitmap1mask.bmp");
	Map->Load(L"map.bmp", L"bitmap1mask.bmp");
	...
	for (i = 0; i < 9; i++)
	{
		...
		Effect1->NodeData.Load(L"bitmap1.bmp", L"bitmap1mask.bmp");
		Effect(i);
		...
		Effect2->NodeData.Load(L"bitmap1.bmp", L"bitmap1mask.bmp");
...
{ 
																		...
																		//연결리스트를 사용하여 여러 미사일을 발사한다.
	{
		...
		weapon->Load(L"bitmap1.bmp",L"bitmap1mask.bmp");						//미사일 이미지 로드
		weaponRt1.left = charRt1.left + (charRt1.right / 2);						//미사일이 주인공객체의 중간 위에서 발사되게 주인공의 위치 받는중
